...
private val LightColorScheme = lightColorScheme(
    ...
    surfaceVariant = TourOSColors.SurfaceVariant,
    onSurfaceVariant = TourOSColors.TextSecondary,
    surfaceContainer = TourOSColors.Background,
    surfaceContainerLow = TourOSColors.Background,
    surfaceContainerHigh = TourOSColors.Background,
    surfaceContainerHighest = TourOSColors.SurfaceVariant,
    surfaceBright = TourOSColors.Background,
    surfaceDim = TourOSColors.Surface,

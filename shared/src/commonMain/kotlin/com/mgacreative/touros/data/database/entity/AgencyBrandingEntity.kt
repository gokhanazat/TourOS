...
data class AgencyBrandingEntity(
    ...
    @SerialName("hero_title") val heroTitle: String = "Hayalinizdeki Turu Keşfedin",
    @SerialName("hero_subtitle") val heroSubtitle: String = "En iyi tur operatörlerinden karşılaştırmalı teklifler",

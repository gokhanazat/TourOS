...
/**
 * 4.5.3 Viator / TripAdvisor Adaptör Taslağı (Stub Implementation).
 */
class ViatorAdapter : OTAProviderAdapter {
    override val providerId: String = "viator"
    override val providerName: String = "Viator / TripAdvisor"

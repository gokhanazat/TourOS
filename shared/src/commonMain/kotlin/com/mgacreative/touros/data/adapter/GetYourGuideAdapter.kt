...
/**
 * 4.5.3 GetYourGuide Adaptör Taslağı (Stub Implementation).
 */
class GetYourGuideAdapter : OTAProviderAdapter {
    override val providerId: String = "getyourguide"
    override val providerName: String = "GetYourGuide"
